...
import CreateGroupBtn from "../group/CreateGroupBtn";
...
function UserMenu() {
  ...
  // const userName = first_name[0].toUpperCase() + last_name[0].toUpperCase();
  ...
  return (
    <>
      ...
      <Dropdown align="end" autoClose="outside">
        <Dropdown.Toggle id="dropdown-basic" style={avatar}>
          <svg
